...
BOOL EEPROM_Erase(void) {
    return EEPROM_Program((UINT32 volatile * const)0x0400, 0, EEPROM_COMMAND_MASS_ERASE) && EEPROM_Program((UINT32 volatile * const)0x0400, 0, EEPROM_COMMAND_ERASE_VERIFY);
}
